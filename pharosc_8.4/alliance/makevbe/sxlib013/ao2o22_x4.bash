#!/bin/bash
# ao2o22_x4.bash created using makenewvbe on 2007-07-16:19h41 by graham
cell=ao2o22_x4

cat ../../../alliance/vbe/ssxlib200/ao2o22_x4.vbe | \
../../../alliance/bin/chfield tphh_i0_q 146 | \
../../../alliance/bin/chfield tpll_i0_q 206 | \
...
../../../alliance/bin/chfield tphh_i2_q 145 | \
../../../alliance/bin/chfield tpll_i2_q 223 | \
../../../alliance/bin/chfield rup_i2_q 770 | \
../../../alliance/bin/chfield rdown_i2_q 650 | \
../../../alliance/bin/chfield cin_i2 4 | \
../../../alliance/bin/chfield tphh_i3_q 156 | \
../../../alliance/bin/chfield tpll_i3_q 235 | \
